  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="relative w-full max-w-xl rounded-xl border border-slate-200 bg-white p-6 shadow-2xl">
        ...
        {errorMsg && (
          <div className="mt-4 flex items-center gap-2 p-3 rounded-lg bg-rose-50 border border-rose-200 text-xs text-rose-800">
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="w-full h-8 px-3 text-xs font-mono bg-white border border-slate-300 rounded-lg text-slate-900 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600"
          />
        </div>
        ...
        >
          ...
          <p className="text-sm font-medium text-slate-800">
            Drag & drop your CSV file here, or <span className="text-blue-600 font-semibold underline">browse</span>
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            {Object.values(BENCHMARKS).map((bm) => (
              <button
                ...
                className="flex flex-col text-left p-2.5 rounded-lg bg-slate-50 border border-slate-200 hover:border-blue-400 hover:bg-blue-50/30 transition-all group"
              >
        ...
        <div className="mt-6 pt-4 border-t border-slate-200 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 bg-slate-100 border border-slate-200 rounded-lg hover:bg-slate-200 transition-colors shadow-xs"
          >
            Cancel
          </button>
        </div>
